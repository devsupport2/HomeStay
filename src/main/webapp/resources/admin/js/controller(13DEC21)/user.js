	...
	function ($scope, $filter, $http, $window, $location, $timeout) {
		...
		/*	else if($scope.usertypenameadd == 2 && !$scope.hourlywagesadd) {				
			...
			*/
				...
				var a = 0;
				$scope.spin = 1;		
				var link = baseUrl+'addUser?companyname='+$scope.companynameadd+'&firstname='+$scope.firstnameadd+'&middlename='+$scope.middlenameadd+'&lastname='+$scope.lastnameadd+'&usertypename='+$scope.usertypenameadd+'&gender='+$scope.genderadd+'&dateofbirth='+$scope.dateofbirth+'&aadharnumber='+$scope.aadharnumber+'&passportnumber='+$scope.passportnumberadd+'&pannumber='+$scope.pannumberadd+'&address1='+$scope.address1add+'&address2='+$scope.address2add+'&address3='+$scope.address3add+'&statename='+$scope.statenameadd+'&cityname='+$scope.citynameadd+'&pincode='+$scope.pincodeadd+'&mobilenumber='+$scope.mobilenumberadd+'&landlinenumber='+$scope.landlinenumberadd+'&email='+$scope.emailadd+'&password='+$scope.passwordadd+'&code='+$scope.codeadd+'&hourlywages='+$scope.hourlywagesadd+'&overtimewages='+$scope.overtimewagesadd+'&clientcategory='+$scope.clientcategory;
