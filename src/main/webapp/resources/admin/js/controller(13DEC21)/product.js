app.controller('productCtrl', ['$scope', '$filter', '$http', '$window', '$location', '$timeout' ,
		...
		$scope.addProduct = function() {
			...
			if(categoryname==undefined || categoryname=="") {				
				...
				var link = baseUrl+'addProduct?categoryname='+categoryname+'&subcategoryname='+subcategoryname+'&brandname='+brandname+'&saletype='+saletype+'&productname='+pro2+'&partnumber='+partnumber+'&unitid='+unitid+'&hsn='+hsn+'&description='+description;				
