		...
		<div class="modal fade" id="clientCategoryModal">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
						<h4 class="modal-title">Add client category</h4>
					</div>
					<form ng-submit="addClientCategory()">
						<div class="modal-body">
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<label>Client Category Name<font color="red" size="3">*</font></label>
								...
								<div class="col-md-12">
									<div class="form-group">
										<label>Client Category code<font color="red" size="3">*</font></label>
										<input type="text" id="categorycode" name="categorycode" ng-model="categorycode" placeholder="category Name" class="form-control" autofocus ng-change="setFlag()">
										<p ng-show="errorUserType == 1" style="color: red;">{{msgUserType}}</p>
									</div>
								</div>
