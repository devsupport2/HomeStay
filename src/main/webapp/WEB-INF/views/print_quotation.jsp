...
<html>
	...
	<body ng-app="MyApp" ng-controller="printQuotationCtrl" ng-cloak ng-init='getQuotationDetailForPrint(<%= request.getParameter("quotationid")%>)'>
		<table id="printable" style="border:solid 1px #bcc2cf; font-family: Times New Roman;" align="center" width="70%" cellspacing="0" cellpadding="0" border="0">
			<tbody>
				<tr>
					...
					<td>
						<table border="0" cellpadding="1" cellspacing="1" style="width:100%">
							<tbody>
								<tr>
									<td>
										<table border="0" cellpadding="1" cellspacing="1" style="width:100%">
											<tbody>
												<tr>
													<td colspan="2"> <h3 style="text-align: center;">	{{getCompanyById.companyName}}</h3></td>
												</tr>
												<tr>
												    <td style="text-align: center;">
														<img src="{{getCompanyById.companyLogo}}"/>
													</td>
													<td>
														<div style="text-align: right;">
													        ...
													        <br>
															Contact : {{getCompanyById.contactNo1}}, {{getCompanyById.contactNo2}} <br>
														 	f: {{getCompanyById.faxNo}}<br>
															 
															  
														      Email : {{getCompanyById.email}}
														</div>
													</td>
									...
									<td>
										<table border="0" cellpadding="1" cellspacing="1" style="width:100%">
											<tbody>
												<tr>
													<td>
														REF : {{getQuotationDetail.quotationNo}}</td>
													<td style="text-align: right;">
														DATE {{getQuotationDetail.quotationDate}}
													</td>
												</tr>
												<tr>
												    <td>
								...
								<tr>
									<td>
									<div ng-bind-html="getQuotationDetail.coverLetter | to_trusted"></div>
		...
		<table id="non-printable" align="center" width="1060" cellspacing="0" cellpadding="0" border="0" style="margin-top: 20px;">
			<tbody>
				<tr>
					<td width="49%" align="right"><input type="button" value="Print" onClick="printData()"></td>
					<td width="2%"></td>
