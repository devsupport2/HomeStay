...
<header class="main-header">
	<a href="<%=request.getContextPath() %>/home" class="logo" style="background-color:#d11957;">
		<!--<span class="logo-mini"><b>CRM</b></span>
		<span class="logo-lg"><b>Admin</b>CRM</span>-->
		<img class="img-responsive" style="display: unset; background-color:#d11957;         height: 100%; " src="<%=request.getContextPath() %>/resources/admin/images/user2-160x160.png" alt="Home Stay">
	</a>
	<nav class="navbar navbar-static-top" role="navigation" style="background-color:#d11957; width:100%;">
		...
		<div class="navbar-custom-menu">
			<ul class="nav navbar-nav">				
				...
				<li class="dropdown user user-menu">
					...
					<ul class="dropdown-menu">
						<li class="user-header" style="background-color:#d11957;">
