...
<html lang="en">
	...
	<body ng-app="MyApp" ng-controller="userCtrl" ng-cloak class="skin-blue sidebar-mini">
								...
								<table class="table no-margin">
									...
									<tbody>
										...
										<tr ng-repeat="item in getUsers" style="cursor:pointer;cursor:hand">
											...
											<td ng-click="getUser(item.userId)" title="Edit Record" data-toggle="modal" data-target="#editModal">{{item.cityName}}</td>																																	
											<td ng-click="getUser(item.userId)" title="Edit Record" data-toggle="modal" data-target="#editModal">{{item.state}}</td>																																	
		...
		<!--for client category  -->
		<div class="modal fade" id="clientCategoryModal">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
						<h4 class="modal-title">Add Catetegory </h4>
					</div>
					<form ng-submit="addClientCategory()">
						<div class="modal-body">
						<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label>Category Name<font color="red" size="3">*</font></label>
										<input type="text" id="categoryname" name="categoryname" ng-model="categoryname" placeholder="Category Name" class="form-control" autofocus ng-change="setFlag()">
										<p ng-show="errorCategory == 1" style="color: red;">{{msgCategory}}</p>
									</div>									
								</div>								
								<div class="col-md-3">
									<div class="form-group">
										<label>Category Code</label>
										<input type="text" id="categorycode" name="categorycode" ng-model="categorycode" class="form-control">										
									</div>									
								</div>
						...
						<div class="modal-footer">
							<div class="row">								
								<div class="col-md-6 text-left">
									<strong ng-show="clientCategorySuccess == 1" style="color: green;"><span class="fa fa-check-circle"></span> {{clientCategorySuccessMsg}}</strong>
									<strong ng-show="clientCategoryError == 1" style="color: red;"><span class="fa fa-times-circle"></span> {{clientCategoryErrorMsg}}</strong>
								</div>
								<div class="col-md-6 text-right">
									<button type="submit" ng-disabled="clientCategorySpin == 1" class="btn btn-success"><i class="fa fa-refresh fa-spin" ng-if="clientCategorySpin == 1"></i> Save changes</button>
									<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>	
								</div>
							</div>					
						</div>
