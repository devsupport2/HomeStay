	...
	<body ng-app="MyApp" ng-controller="enquiryCtrl" ng-cloak class="skin-blue sidebar-collapse sidebar-mini">
		...
		<div class="wrapper">		
			...
			<div class="content-wrapper">
				<section class="content-header">
					...
					<ol class="breadcrumb">
					<!-- <button class="btn btn-success" data-toggle="modal" style="  margin-top: -8px;  margin-right: 15px;" data-target="#importModal">Import Enquiry</button> -->
					<button class="btn btn-success" data-toggle="modal"   style="  margin-top: -8px;  margin-right: 15px;"  ng-click="ReportData()" data-target="#ReportModal">Generate Report</button>
					<button class="btn btn-success" data-toggle="modal"   style="  margin-top: -8px;  margin-right: 15px;"  ng-click="exportData()" data-target="#exportModal">Export Enquiry</button>
						...
						<form>						
							<div class="box-body">
								...
								<div class="row">
									...
									<div class="col-md-2">
										<label>Reference Type</label> <!--  ng-options="item.userTypeId as item.userTypeName for item in getUserTypes"  -->
										<div class="input-group">
											<select id="usertypeidadd" name="usertypeidadd" ng-model="usertypeidadd" ng-change="getUserByUserType(usertypeidadd)" class="form-control">
												<option value="">Reference Type</option>
											
											
											<option ng-repeat="item in getUserTypes" value="{{item.userTypeId}}">{{item.userTypeName}} </option>
							...
							<div class="box box-tgsc">
								<div class="box-header with-border">
									...
									<div class="row" style="    margin-top: 13px;"> 
										<div class="col-md-3" id="dat1">
											<div class="input-group">
												<input type="date" id="start-date" name="date"  ng-model="StartDate">
											</div>
										</div>
										<div class="col-md-3" id="dat2">
											<div class="input-group">
												<input type="date" id="end-date" name="date"  ng-model="EndDate">
											</div>
										</div>
										...
										<div class="col-md-2 text-right" id="sear2">
											<div class="form-group">
										...
										<table class="table no-margin">
											...
											<tbody>
												...
												<tr ng-repeat="item in getEnquiries" style="cursor:pointer; cursor:hand;" ng-style="(item.status == 'w' || item.status == 'cw') && {'color':'green'} || (item.status == 'l' || item.status == 'cl') && {'color':'red'} || item.status == 'o' && {'color':'blue'} || {'color': '#202020'}">
													...
													<td ng-click="getEnquiryDetail(item.enquiryId)" title="Edit Record" data-toggle="modal" data-target="#editModal" class="text-left">{{item.firstName}} {{item.lastName}}<br>{{item.userCompanyName}}<i class="fa fa-info-circle" data-toggle="tooltip" title="" data-original-title="Email-Id: {{item.phone}}, Mobile-Number: {{item.email}}" aria-hidden="true"></i></td>
					...
					<div class="modal-body">
						<div class="nav-tabs-custom" >
							<ul class="nav nav-tabs pull-right" id="navForMobile" style="margin-right: 20px;">
							   <li id="quotationli"><a href="#tab5" data-toggle="tab">quotation</a></li>
							   <!-- 	<li><a ng-click="getUser(clientid)" href="#tab4" data-toggle="tab">User</a></li> -->
								
								<li id="userli"><a href="#tab4" data-toggle="tab">User</a></li>
								
								<li id="cefli"><a href="#tab3" data-toggle="tab">Change Enquiry Status</a></li>
								<li id="lfli"><a href="#tab2" data-toggle="tab">Logs & Follow-ups</a></li>
								<li class="active" id="eeli"><a href="#tab1" data-toggle="tab">Edit Enquiry</a></li>
	 ...
	 -->	
			...
			<div class="modal-dialog">
				<div class="modal-content" style="padding-bottom: 40px;">
					<div class="modal-header">
						<div class="row">	
							<div class="col-md-6">
								<h4 class="modal-title"> <i class="fa fa-cloud-download" aria-hidden="true"></i> Generate Report</h4>								
							</div>
					...
					<div>
						...
						<div class="col-md-6"  style="margin-top:5px;margin-bottom:5px;">
											<div class="">
												<input type="date" id="start-ref-date"  style="  margin-left: 15px;  width: -webkit-fill-available;"name="date"  ng-model="StartRefDate">
											</div>
										</div>
										<div class="col-md-6"  style="margin-top:5px;margin-bottom:5px;">
											<div class="">
												<input type="date" id="end-ref-date" name="date" style=" margin-right: 15px;   width: -webkit-fill-available;" ng-model="EndRefDate">
											</div>
										</div>
						...
						<div class="col-md-12" style="margin-top:5px;margin-bottom:5px;">
										...
										<div class="input-group" style="    width: inherit;">
											<select id="usertypeidadd" name="usertypeidadd" ng-model="referenceId" class="form-control">
												<option value="">Reference Type</option>
					...
					<div class="modal-footer">
						<div class="row">
							...
							<div class="col-md-6 text-right">
								<button type="submit" class="btn btn-success" ng-click="searchReferenceType(item)"><i class="fa fa-refresh fa-spin" ng-if="spin == 1"></i>Submit</button>
								<input type="button" class="btn btn-danger" data-dismiss="modal" value="Cancel">	
							</div>
						</div>	
					</div>
					...
					<div class="table-responsive" style="  margin-right: 15px;  padding-left: 15px; border: 2px solid darkgray;  margin-top: 15px;  margin-left: 15px;"  ng-show="getRefencesReportEnquiries.length>=0" >
										<table class="table no-margin">
											<thead>
												<tr>
													<th class="text-left" width="15%">EnquiryNo/Date</th>																						
													<th class="text-left" width="25%">Client</th>
													
													<th class="text-left" width="45%">EnquiryId</th>
													<th class="text-left" width="45%">ClientId</th>
													<th class="text-left" width="45%">EnquiryVia</th>
													<th class="text-left" width="45%">RefenceTypeId</th>
													<th class="text-left" width="45%">EnquriRemarks</th>
													<th class="text-left" width="45%">EmailId</th>
													<th class="text-left" width="45%">MobileNO</th>
													<th class="text-left" width="45%">ReferenceType</th>
											...
											<tbody>
												...
												<tr ng-repeat="item in getRefencesReportEnquiries" ng-show="getRefencesReportEnquiries.length>0" style="cursor:pointer; cursor:hand;" ng-style="(item.status == 'w' || item.status == 'cw') && {'color':'green'} || (item.status == 'l' || item.status == 'cl') && {'color':'red'} || item.status == 'o' && {'color':'blue'} || {'color': '#202020'}">
													<td   class="text-left">{{item.enquiryNo}}<br>{{item.enquiryDate}}</td>												
													<td   class="text-left">{{item.firstName}} {{item.lastName}}<br></td>
												
													<td  class="text-left">{{item.enquiryId}}</td>	
													<td  class="text-left">{{item.clientId}}</td>	
													<td class="text-left">{{item.enquiryVia}}</td>	
													<td  class="text-left">{{item.referenceId}}</td>	
													<td  class="text-left">{{item.enquriRemarks}}</td>	
													<td  class="text-left">{{item.phone}}</td>	
													<td class="text-left">{{item.email}}</td>	
													<td class="text-left">{{item.UserType}}</td>
												</tr>
											</tbody>
											<tfoot ng-if="getEnquiries != ''">
												<tr>
		...
		<div id="toDoModal" class="modal fade">
			...
			<div class="table-responsive"  style="display:none" id="exportable">
										<table class="table no-margin">
											<thead>
												<tr>
													<th class="text-left" width="15%">EnquiryNo/Date</th>																						
											...
											<tbody>
												...
												<tr ng-repeat="item in getEnquiries" style="cursor:pointer; cursor:hand;" ng-style="(item.status == 'w' || item.status == 'cw') && {'color':'green'} || (item.status == 'l' || item.status == 'cl') && {'color':'red'} || item.status == 'o' && {'color':'blue'} || {'color': '#202020'}">
													...
													<td ng-click="getEnquiryDetail(item.enquiryId)" title="Edit Record" data-toggle="modal" data-target="#editModal" class="text-left">{{item.firstName}} {{item.lastName}}<br>{{item.userCompanyName}}<i class="fa fa-info-circle" data-toggle="tooltip" title="" data-original-title="Email-Id: {{item.phone}}, Mobile-Number: {{item.email}}" aria-hidden="true"></i></td>
													<td ng-click="getEnquiryDetail(item.enquiryId)" title="Edit Record" data-toggle="modal" data-target="#editModal" class="text-left"><span ng-repeat="item1 in allEnquiryProducts" ng-if="item1.enquiryId == item.enquiryId">{{item1.productDetail}}<span ng-show="!$last">,&nbsp;</span></span></td>
													<td ng-click="getEnquiryDetail(item.enquiryId)" title="Edit Record" data-toggle="modal" data-target="#editModal" class="text-left">{{item.enquiryId}}</td>	
													<td ng-click="getEnquiryDetail(item.enquiryId)" title="Edit Record" data-toggle="modal" data-target="#editModal" class="text-left">{{item.clientId}}</td>	
													<td ng-click="getEnquiryDetail(item.enquiryId)" title="Edit Record" data-toggle="modal" data-target="#editModal" class="text-left">{{item.enquiryVia}}</td>	
													<td ng-click="getEnquiryDetail(item.enquiryId)" title="Edit Record" data-toggle="modal" data-target="#editModal" class="text-left">{{item.referenceId}}</td>	
													<td ng-click="getEnquiryDetail(item.enquiryId)" title="Edit Record" data-toggle="modal" data-target="#editModal" class="text-left">{{item.enquriRemarks}}</td>	
													<td ng-click="getEnquiryDetail(item.enquiryId)" title="Edit Record" data-toggle="modal" data-target="#editModal" class="text-left">{{item.phone}}</td>	
